...
import { getreduce, reducedelete } from "../reduceSlice";

const ReduceDelete = ({ reduceDetail1 }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    dispatch(reducedelete({ token, id: reduceDetail.id }))
      .unwrap()
      .then((res) => {
