...
import { batchContainerDelete } from "../../batch/batchDetailSlice";

const BatchContainerDelete = ({ id, title }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(batchContainerDelete({ token, id }))
        .unwrap().then((res) => {
            setOpen(false);
            SetError("");
        })
...
export default BatchContainerDelete;
