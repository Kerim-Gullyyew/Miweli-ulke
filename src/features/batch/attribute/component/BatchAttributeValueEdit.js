...
import { batchAttributeValueEdit } from "../../batch/batchDetailSlice";

const BatchAttributeValueEdit = ({ id, attr_id, value }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const json = {
      ...
      batch_id: batch_id,
      batch_batch_id: attr_id,
    };

    try {
      await dispatch(batchAttributeValueEdit({ token, id, json }))
        .unwrap()
        .then((res) => {
          setOpen(false);
          SetError("");
...
export default BatchAttributeValueEdit;
