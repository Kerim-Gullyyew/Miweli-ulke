        ...
        <div className=" px-5 space-y-3 pt-3">
          <div className="flex-wrap desktop:grid desktop:grid-cols-2">
            <div className="grid grid-cols-2 items-center">
              ...
              <div className="grid grid-cols-1 px-3 whitespace-nowrap">
                {containerPallet?.title}
              </div>
            </div>
            <div className="grid grid-cols-2 items-center">
              <div className="grid grid-cols-1 whitespace-nowrap font-bold">
