...
import { transferPalletDelete } from "../../transferDetailSlice";

const TransferPalletDelete = ({ id, title }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(transferPalletDelete({ token, id }))
        .unwrap()
        .then((res) => {
          setOpen(false);
          SetError("");
...
export default TransferPalletDelete;
