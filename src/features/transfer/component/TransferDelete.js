...
import { getTransfer, transferdelete } from "../transferSlice";

const TransferDelete = ({ transferDetail1 }) => {
  ...
  useEffect(() => {
    settransferDetail(transferDetail1);
  }, [transferDetail1]);

  const handleSubmit = async (e) => {
    e.preventDefault();
    dispatch(transferdelete({ token, id: transferDetail.id }))
      .unwrap()
      .then((res) => {
