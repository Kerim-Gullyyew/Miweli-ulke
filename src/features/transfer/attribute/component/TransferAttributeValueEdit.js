...
import { AttributeValueEdit } from "../../transferDetailSlice";

const TransferAttributeValueEdit = ({id, attr_id, value}) => {
      ...
      const onSetAttributeValueChanged = (e) => {
        ...
        const handleSubmit = async (e) => {
          ...
          const json = {
            ...
            pctransfer_id: transfer_id,
            pctransfer_attribute_id: attr_id
          };
          let isCancelled = false;
          
          try {
            await dispatch(AttributeValueEdit({ token, id, json }))
              .unwrap().then((res) => {
                  setOpen(false);
                  SetError("");
              });
  ...
  return (
    <>
      <FaPen
        ...
        size={20}
        className="text-blue-800 mr-3 col-span-1 cursor-pointer"
      />
                    ...
                    <div className="">
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2 grid grid-cols-1 space-y-3">
                          ...
                          <label htmlFor="AttrValue">Bahasy</label>
...
export default TransferAttributeValueEdit