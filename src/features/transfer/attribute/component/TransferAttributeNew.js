...
import { createAttribute } from "../transferAttributeSlice";

const TransferAttributeNew = () => {
  ...
  const onSetAttributeNameChanged = (e) => {
    setAttributeName(e.target.value);
  };

  const AttributeCreate = (e) => {
    // e.preventDefault();
    ...
    dispatch(createAttribute({ token, json }))
      .unwrap()
      .then((res) => {
        SetError("");
        setOpen(false);
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2 grid grid-cols-1 space-y-3">
                          ...
                          <div className="flex items-center border-b border-blue-500 py-2">
                            <input
                              value={AttributeName}
                              onChange={onSetAttributeNameChanged}
                              onKeyDown={(e) => {
                                if (e.key === "Enter") {
                                  AttributeCreate();
                                }
...
export default TransferAttributeNew;
