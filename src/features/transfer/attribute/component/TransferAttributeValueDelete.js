...
import { transferAttributeValueDelete } from "../../transferDetailSlice";

const TransferAttributeValueDelete = ({ id }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await dispatch(transferAttributeValueDelete({ token, id: id }))
        .unwrap()
        .then((res) => {
          setOpen(false);
          SetError("");
...
export default TransferAttributeValueDelete;
